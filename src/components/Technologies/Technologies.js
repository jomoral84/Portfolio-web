...
const Technologies = () =>  (
   <Section id="tecnologias">
     ...
     <SectionText>Trabajo y conozco un conjunto de tecnologías aplicadas al desarrollo web desde el back-end a front-end.</SectionText>
   <List>
     <ListItem>
     ...
     <ListItem>
      ...
      <ListContainer>
         <ListTitle>Back-End</ListTitle>
          <ListParagraph>Experiencia en <br /> 
            PHP, NodeJs</ListParagraph>
    </ListContainer>
     </ListItem>
